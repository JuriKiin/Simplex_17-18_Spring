...
class Application
{
	...
	std::vector<uint> numSidesInOrbit;
	std::vector<std::vector<vector3>> orbitLocations;
	std::vector<uint> indexOfCurrentLocation;
	String m_sProgrammer = "Juri Kiin - jak5125@rit.edu";
